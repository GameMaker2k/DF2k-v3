...
<?php
if ($_GET['act']=="View") {?>
<title><?php echo $BoardName?> <?php echo $TitleLine ?> <?php echo $adminlang2['mod tools']; ?> <?php echo $TitleLine ?> <?php echo $adminlang2['tag tools']; ?></title>
<?php }
...
$i=0;
while ($i < $num) {
$TagID=mysql_result($result,$i,"ID");
$UsersID=mysql_result($result,$i,"UserID");
$GuestName=mysql_result($result,$i,"GuestName");
$Post=mysql_result($result,$i,"Post");
?><input type="radio" id="ID<?php echo $TagID ?>" name="IDN" value="<?php echo $TagID ?>" /><label for="ID<?php echo $TagID ?>"><?php echo $Post ?></label><?php echo "<br />\r\n"; ++$i; } ?>
<select size="1" class="Menu" name="act">
<!--<option value="Edit"><?php echo $adminlang2['edit topic']; ?></option>-->
<option selected value="Delete"><?php echo $adminlang2['delete tag']; ?></option>
</select><br />
