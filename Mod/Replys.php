...
<?php
if ($_GET['act']=="View") {?>
<title><?php echo $BoardName?> <?php echo $TitleLine ?> <?php echo $adminlang2['mod tools']; ?> <?php echo $TitleLine ?> <?php echo $adminlang2['reply tools']; ?></title>
<?php }
...
<?php
$query="SELECT * FROM ".$TablePreFix."Posts ORDER BY ID";
...
?><input type="radio" id="ID<?php echo $ReplyID ?>" name="IDN" value="<?php echo $ReplyID ?>" /><label for="ID<?php echo $ReplyID ?>"><?php echo $Post ?></label><?php echo "<br />\r\n"; ++$i; } ?>
<select size="1" class="Menu" name="act">
<!--<option value="Edit"><?php echo $adminlang2['edit topic']; ?></option>-->
<option selected value="Delete"><?php echo $adminlang2['delete reply']; ?></option>
</select><br />
...
<?php }	}
if ($_POST['act']=="Delete") {
	$sqlrowdelete = "DELETE FROM ".$TablePreFix."Posts WHERE id=".$_POST['IDN']."";
