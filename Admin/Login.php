...
if ($_GET['act']==null) {
	$_GET['act']="View"; }
if ($_GET['act']=="View") {?>
<title><?php echo $BoardName?> <?php echo $TitleLine ?> <?php echo $adminlang2['logging into admin cp']; ?></title>
<?php }
...
echo ''.$adminlang2['password is right welcome'].' '.$_SESSION['MemberName'].'.';
echo '<meta http-equiv="Refresh" Content="0; URL=index.php?act=View">'; }
if ($YourPassword!=$UserPassword) {
echo ''.$adminlang2['password is not right'].'<meta	http-equiv="Refresh" Content="0; URL=Login.php?act=Login">'; } }	}
if ($_GET['act']=="Logout") {
