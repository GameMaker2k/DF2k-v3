...
<?php
if ($_GET['act']=="View") {?>
<title><?php echo $BoardName?> <?php echo $TitleLine ?> <?php echo $adminlang2['admin cp']; ?> <?php echo $TitleLine ?> <?php echo $adminlang2['forum tools']; ?></title>
<?php }
...
<?php
$query="SELECT * FROM ".$TablePreFix."Forums ORDER BY ID";
...
?><input type="radio" id="ID<?php echo $ForumID ?>" name="IDN" value="<?php echo $ForumID ?>" /><label for="ID<?php echo $ForumID ?>"><?php echo $ForumName ?></label><?php echo "<br />\r\n"; ++$i; } ?>
<select size="1" class="Menu" name="act">
<option selected value="Edit"><?php echo $adminlang2['edit forum']; ?></option>
<option value="Delete"><?php echo $adminlang2['delete forum']; ?></option>
<option value="New"><?php echo $adminlang2['new forum']; ?></option>
</select><br />
...
<?php }	}
if ($_POST['act']=="Edit") {
$result = mysql_query("SELECT * FROM ".$TablePreFix."Forums");
...
<div align="center">
 ...
 <table border="1" cellpadding="2" cellspacing="3" width="100%">
  <tr>
   <td width="28%"><form method="post" name="Member" action="?act=EditForum">
<label for="IDNumber"><?php echo $adminlang2['insert id number for forum']; ?></label><br />
<input type="text" class="TextBox" name="NewForumid" size="20" id="IDNumber" value="<?php echo $OldForumid ?>" /><br />
<label for="CatID"><?php echo $adminlang2['insert id number for category']; ?></label><br />
<input type="text" class="TextBox" name="NewCategoryid" size="20" id="CatID" value="<?php echo $OldCategoryid ?>" /><br />
<label for="ForumName"><?php echo $adminlang2['insert name for forum']; ?></label><br />
<input type="text" class="TextBox" name="NewForumName" id="ForumName" value="<?php echo $OldForumName ?>" size="20" /><br />
<label for="VisibleForum"><?php echo $adminlang2['should forum be visible']; ?></label><br />
<select size="1" name="NewShowForum" id="VisibleForum" class="Menu"><option value="<?php echo $OldShowForum ?>" selected="selected" class="Menu"><?php echo $adminlang2['keep old']; ?></option><option value="Yes"><?php echo $adminlang2['yes']; ?></option><option value="No"><?php echo $adminlang2['no']; ?></option></select><br />
<label for="ForumType"><?php echo $adminlang2['forum type']; ?></label><br />
<select size="1" name="NewForumType" id="ForumType" class="Menu"><option value="<?php echo $OldForumType ?>" selected="selected" class="Menu"><?php echo $adminlang2['keep old']; ?></option><option value="Forum"><?php echo $adminlang2['forum']; ?></option><option value="SubForum"><?php echo $adminlang2['subforum']; ?></option></select><br />
<label for="InSubForum"><?php echo $adminlang2['forum/subforum should be in']; ?></label><br />
<input type="text" class="TextBox" name="NewInSubForum" size="20" value="<?php echo $OldInSubForum ?>" id="InSubForum" /><br />
<label for="ForumDescription"><?php echo $adminlang2['insert description about forum']; ?></label><br />
<textarea class="TextBox" rows="3" name="NewForumDescription" cols="20" id="ForumDescription"><?php echo $OldForumDescription ?></textarea><br />
...
<input type="hidden" class="HiddenTextBox" style="display: none;" name="OldForumid" value="<?php echo $OldForumid ?>" /> 
<input type="hidden" class="HiddenTextBox" style="display: none;" name="act" value="EditForum" /> 
<input type="submit" class="Button" value="<?php echo $adminlang2['edit forum']; ?>" /> <input type="reset" class="Button" value="<?php echo $adminlang2['reset']; ?>" />
</form></td>
  </tr>
 </table>
 </center>
...
if ($_POST['act']=="EditForum") {
$NewForumName = stripcslashes(htmlentities($_POST['NewForumName'], ENT_QUOTES));
$NewForumName = preg_replace("/\&amp;#(.*?);/is", "&#$1;", $NewForumName);
$NewForumDescription = stripcslashes(htmlentities($_POST['NewForumDescription'], ENT_QUOTES));
$YourPost = $NewForumDescription;
require( '../misc/HTMLTags.php');
$NewForumDescription = $YourPost;
$NewForumDescription = preg_replace("/\&amp;#(.*?);/is", "&#$1;", $NewForumDescription);
$query="UPDATE ".$TablePreFix."Forums SET ID=".$_POST['NewForumid'].",CategoryID=".$_POST['NewCategoryid']." ,Name='".$NewForumName."',ShowForum='".$_POST['NewShowForum']."',ForumType='".$_POST['NewForumType']."',InSubForum=".$_POST['NewInSubForum'].",Description='".$NewForumDescription."' WHERE ID=".$_POST['OldForumid']."";
mysql_query($query);
...
<div align="center">
 ...
 <table border="1" cellpadding="2" cellspacing="3" width="100%">
  <tr>
   <td width="28%"><form method="post" name="Member" action="?act=NewForum">
<label for="IDNumber"><?php echo $adminlang2['insert id number for forum']; ?></label><br />
<input type="text" class="TextBox" name="NewForumid" size="20" id="IDNumber" /><br />
<label for="CatID"><?php echo $adminlang2['insert id number for category']; ?></label><br />
<input type="text" class="TextBox" name="NewCategoryid" size="20" id="CatID" value="<?php echo $OldCategoryid ?>" /><br />
<label for="ForumName"><?php echo $adminlang2['insert name for forum']; ?></label><br />
<input type="text" class="TextBox" name="NewForumName" id="ForumName" size="20" /><br />
<label for="VisibleForum"><?php echo $adminlang2['should forum be visible']; ?></label><br />
<select size="1" name="NewShowForum" id="VisibleForum" class="Menu"><option value="<?php echo $OldShowForum ?>" selected="selected" class="Menu"><?php echo $adminlang2['keep old']; ?></option><option value="Yes"><?php echo $adminlang2['yes']; ?></option><option value="No"><?php echo $adminlang2['no']; ?></option></select><br />
<label for="ForumType"><?php echo $adminlang2['forum type']; ?></label><br />
<select size="1" name="NewForumType" id="ForumType" class="Menu"><option value="<?php echo $OldForumType ?>" selected="selected" class="Menu"><?php echo $adminlang2['keep old']; ?></option><option value="Forum"><?php echo $adminlang2['forum']; ?></option><option value="SubForum"><?php echo $adminlang2['subforum']; ?></option></select><br />
...
<input type="radio" class="TextBox" name="LineBreaks" id="LineBreaks1" value="Auto" checked="checked" /><label for="LineBreaks1" title="<?php echo $adminlang2['use to put linebreaks']; ?>"><?php echo $adminlang2['auto linebreaks mode']; ?></label> 
<input type="radio" class="TextBox" name="LineBreaks" id="LineBreaks2" value="Raw" /><label for="LineBreaks2" title="<?php echo $adminlang2['use if you are making table/list']; ?>"><?php echo $adminlang2['raw linebreaks mode']; ?></label><br />
<input type="hidden" class="HiddenTextBox" style="display: none;" name="act" value="NewForum" /> 
<input type="submit" class="Button" value="Create Forum" /> <input type="reset" class="Button" value="<?php echo $adminlang2['reset']; ?>" />
</form></td>
  </tr>
 </table>
 </center>
...
if ($_POST['act']=="NewForum") {
if ($_POST['NewForumid']==null) {
$Error="Yes";
echo "".$adminlang2['please the errors']." <br />\n<strong>".$adminlang2['you need to put id']."</strong><br />"; }
if ($_POST['NewForumName']==null) {
$Error="Yes";
echo "".$adminlang2['please the errors']." <br />\n<strong>".$adminlang2['you need to put forum name']."</strong><br />"; }
if ($_POST['NewInSubForum']==null) {
$NewInSubForum=0; }
if ($_POST['NewForumDescription']==null) {
$Error="Yes";
echo "".$adminlang2['please the errors']." <br />\n<strong>".$adminlang2['you need to put description for forum']."</strong><br />"; }
$sql_id_check = mysql_query("SELECT Email FROM ".$TablePreFix."Members WHERE Email=".$_POST['NewForumid']."");
$id_check = mysql_num_rows($sql_id_check);
if($id_check > 0) {
echo "".$adminlang2['please the errors']." <br />\n<strong>".$adminlang2['you need to pick new id']."</strong><br />"; }
if ($Error=="Yes") {
mysql_close();
exit(); }
$NewForumName = stripcslashes(htmlentities($_POST['NewForumName'], ENT_QUOTES));
...
$NewForumDescription = $YourPost;
$NewForumDescription = preg_replace("/\&amp;#(.*?);/is", "&#$1;", $NewForumDescription);
$query = "INSERT INTO ".$TablePreFix."Forums VALUES (".$_POST['NewForumid'].",".$_POST['NewCategoryid'].",'".$NewForumName."','".$_POST['NewShowForum']."','".$_POST['NewForumType']."',".$_POST['NewInSubForum'].",'".$NewForumDescription."')";
mysql_query($query);
	echo '<meta http-equiv="Refresh" Content="0; URL=index.php?act=View">'; }
